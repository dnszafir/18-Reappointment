...
%Research funding under these awards is supported by the National Science Foundation (three proposals), US Air Force (two proposals), and the University's Innovative Seed Grant program (two proposals).
...
%used results from this research to 
...
%capture interactions between color and other encoding channels 
consider multivariate datasets and to blend these models with Bayesian models %derived from expert design recommendations 
derived from collections of expert designs to drive a novel encoding authoring system that will enable even novice visualization designers to optimize both design and perceptual factors in crafting new visualizations.\todo{citations}
...
%(in the top 5\% of all scored publications) 
...
% to account for factors such as decision risk. 
...
% interpretation aided by statistical algorithms. 
